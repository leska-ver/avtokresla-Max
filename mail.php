<?
  ...
  // Исправляем код на своё ci54422_krylatko 1GmHsZV
  $dbname = 'ci54422_krylatko';//Из сайта имя "Базы данных MySQL"/
  $dbuser = 'ci54422_krylatko';//Из сайта имя "Базы данных MySQL"/
  ...
  $stmt = $pdo->prepare('INSERT INTO orders(tel) VALUES(:tel)');//name, email, message, :name, :email, :message 
